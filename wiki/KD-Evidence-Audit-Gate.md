...
3. [DistiLLM-1](https://arxiv.org/abs/2402.03898)'s five seeds are **eval-time decoding seeds, not training seeds.**
...
AVG: **[GKD](https://arxiv.org/abs/2306.13649) 56.14, DistiLLM 56.35, [DistiLLM-2](https://arxiv.org/abs/2503.07067) 58.69.** Zero variance reporting
...
**[DistiLLM-1](https://arxiv.org/abs/2402.03898), from the same author group, published the refutation in 2024.**
...
> gap [DistiLLM-2](https://arxiv.org/abs/2503.07067) uses to order [GKD](https://arxiv.org/abs/2306.13649) above DistiLLM.**
...
- **CyclicJudge** ([`2603.01865`](https://arxiv.org/abs/2603.01865)) already gives "a variance decomposition that
  partitions benchmark score variance into scenario, generation, judge, and
  residual components" — three of the four axes, jointly.
- **The Coin Flip Judge?** ([`2606.13685`](https://arxiv.org/abs/2606.13685)) measures run-to-run reliability,
...
- **Reliability without Validity** ([`2606.19544`](https://arxiv.org/abs/2606.19544)) covers the judge-model axis —
  21 judges, ~541k judgments, rankings shifting up to 14 positions.

And the *genre* was run two months ago at LLM scale: [`2605.20798`](https://arxiv.org/abs/2605.20798) audits 20
...
- **EasyOPD ([`2607.11012`](https://arxiv.org/abs/2607.11012)) is a library only** — modular config, runnable YAMLs,
...
- Four surveys ([`2402.13116`](https://arxiv.org/abs/2402.13116), [`2407.01885`](https://arxiv.org/abs/2407.01885), [`2503.12067`](https://arxiv.org/abs/2503.12067) TMLR 102pp,
  [`2504.14772`](https://arxiv.org/abs/2504.14772)): **none runs its own controlled comparison with variance, none
  measures comparability.**

## Feasibility — the weak point

**No official student checkpoints are released** for [DistiLLM-2](https://arxiv.org/abs/2503.07067). Only
third-party reproductions exist, and they target the [DistiLLM-1](https://arxiv.org/abs/2402.03898) GPT-2/Llama-2
...
In Table 2, [GKD](https://arxiv.org/abs/2306.13649) is **57.74** on UltraFeedback in *both* the Qwen2 and Mistral
...
**Stage 1 — zero compute, days.** Extract [DistiLLM-1](https://arxiv.org/abs/2402.03898)'s 156 published standard
...
1. **OpenReview reviews unverified** — forum [`rc65N9xIrY`](https://openreview.net/forum?id=rc65N9xIrY) sits behind a
