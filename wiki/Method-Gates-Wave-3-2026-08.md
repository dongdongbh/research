...
| RB | Algebraic role-binding embeddings (HRR/TPR in frozen towers) | SURVIVES-NARROWED — [OC-CLIP (2502.14113)](https://arxiv.org/abs/2502.14113) owns parse+non-commutative score+algebraic swap negatives but is text-conditioned/cross-encoder-shaped; HRR×ITM cell empty (43 papers, 0 CLIP). **Probe update 2026-08-03: kill-arm A CLEARED for spatial roles** (99.9% linear decodability in frozen ROI features; parameter-free sign flip → 100%; pooled embedding and scoring axis at chance — see [[Binding-Root-Cause-Analysis]] §6). Verb-argument case open pending the VisMin unblock | **★★★ (cond.)** | promoted; re-rate again after verb-swap data |
