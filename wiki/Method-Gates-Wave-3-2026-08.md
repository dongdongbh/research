...
| RB | Algebraic role-binding embeddings (HRR/TPR in frozen towers) | SURVIVES-NARROWED — [OC-CLIP (2502.14113)](https://arxiv.org/abs/2502.14113) owns parse+non-commutative score+algebraic swap negatives but is text-conditioned/cross-encoder-shaped; HRR×ITM cell empty (43 papers, 0 CLIP). See [[Binding-Root-Cause-Analysis]] | ★★½ | bench behind Cell A; the role-decodability probe = its kill-arm A |
